...
export const SharedPosts = (props: Props) => {
  return (
    <section>
      ...
      <div className="flex flex-col gap-y-5">
        <article className="w-full cursor-pointer  h-fit p-4 text-[#707070] dark:text-[#9B9B9B] bg-white dark:bg-fill-strong">
          ...
          <p>
            ...
            show just to be used as a punching bag. They need to introduce a new
            strong pirate? Great, send in smoker to catch some fists with his
            face...
          </p>
        </article>
        ...
        <article className="w-full cursor-pointer  h-fit p-4 text-[#707070] dark:text-[#9B9B9B] bg-white dark:bg-fill-strong">
          ...
          <p>
            I like this man so much but holy damn he's basically on the punching
            bag. They need to introduce a new strong pirate? Great, send in
            smoker to catch some fists with his face...
          </p>
        </article>
      </div>
