  ...
  return (
    <>
      ...
      <motion.section
        ...
        className="fixed border border-dawn-weak/20 dark:border-dusk-weak/20 drop-shadow-2xl p-4 z-50 max-w-[95vw] md:max-w-none md:w-[800px] text-dusk-main dark:text-dawn-main h-fit bg-fill-weak dark:bg-fill-strong top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2"
      >
          ...
          <div>
            {selectedFile ? (
              <div className="relative">
                <img
                  src={selectedFile}
                  className="md:w-[510px] h-[150px] border border-dawn-weak/20 dark:border-dusk-weak/20"
                />
                <i
              ...
              <>
                <div className="w-[90vw] md:w-[510px] h-[150px] border border-dashed flex items-center justify-center" />
                <Button
