...
export const CardManga = ({className}: Props) => {
  return (
    <div className="hover:bg-fill-strong hover:drop-shadow-xl dark:hover:bg-fill-weak cursor-pointer relative transition-all ease-in-out duration-200 border-b-[4px] border-b-transparent hover:border-b-fill-strong dark:hover:border-b-fill-weak hover:scale-105 hover:brightness-110">
