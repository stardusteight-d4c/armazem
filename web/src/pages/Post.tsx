    ...
    <div className={style.gridContainer}>
      ...
      <div className={style.mainContent}>
        ...
        <main className="px-28 py-8">
          <article>
            <header>
              <span className="text-3xl font-semibold block pb-8">
              ...
              <div className="flex justify-between border border-dawn-weak/20 dark:border-dusk-weak/20 rounded-sm items-center bg-dusk-weak/10 dark:bg-dusk-weak/5 p-2">
                <div className="flex items-start justify-start gap-x-2">
                  ...
                  <div className="flex flex-col text-dusk-main/90 dark:text-dawn-main/90">
                    <span className="text-lg font-light">Gabriel Sena</span>
                    <span className="text-sm">@blackwive</span>
                  </div>
                </div>
                <span className="text-green">Connected</span>
              </div>
            </header>
            <p className="p-2 text-lg leading-9 mt-8">
          ...
          <div>
            ...
            <section className="flex flex-col">
              <div className="flex relative pt-14 border-t border-t-dawn-weak/20 dark:border-t-dusk-weak/20 py-8  text-[#707070] dark:text-[#9B9B9B] items-start gap-3">
                <div className="h-full left-[18px] -z-10 absolute w-[1px] bg-dawn-weak/20 dark:bg-dusk-weak/20" />
                <img
                ...
                <div className="flex flex-col w-full ">
                  ...
                  >
                    ...
                    Great, send in smoker to catch some fists with his face! I
                    like this man so much but holy damn he's basically on the
                    punching bag. They need to introduce a new strong pirate?
                  ...
                  <div>
                    <div className="flex items-center py-2 space-x-2 justify-end w-full">
                      ...
                      <i className="ri-delete-bin-6-fill border border-dawn-weak/20 dark:border-dusk-weak/20 text-red transition-all duration-200 hover:brightness-125 w-5 h-5 flex justify-center items-center p-2 drop-shadow-sm rounded-sm text-lg cursor-pointer" />
                    </div>
                  </div>
                </div>
              </div>
              <div className="flex relative py-8  text-[#707070] dark:text-[#9B9B9B] items-start gap-3">
                <div className="h-full left-[18px] -z-10 absolute w-[1px] bg-dawn-weak/20 dark:bg-dusk-weak/20" />
                <img
                  src="https://avatars.githubusercontent.com/u/87643260?v=4"
                  alt=""
                ...
                <div className="flex flex-col w-full ">
                  ...
                  >
                    ...
                    Man, your comment just in the top, hohoho. You are a idiot
                    for an case? You know that it mean!??? I Hate you so much
                    man jajaja
                  </span>
                  <div>
                    <div className="flex items-center py-2 space-x-2 justify-end w-full">
            ...
            <section className="flex flex-col">
              <div className="flex relative pt-14 border-t border-t-dawn-weak/20 dark:border-t-dusk-weak/20   text-[#707070] dark:text-[#9B9B9B] items-start gap-3">
                <div className="h-full left-[18px] -z-10 absolute w-[1px] bg-dawn-weak/20 dark:bg-dusk-weak/20" />
                <img
                  src="https://avatars.githubusercontent.com/u/87643260?v=4"
                  alt=""
